...
const StoreProvider = ({ value = [], ...props }) => {
    ...
    // We include {...props} because everything wrapped by the StoreProvider is it's child and needs to be returned (all the other props in the app will be the StoreProvider's children)
